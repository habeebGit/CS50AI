...
def load_data(directory):
    ...
    """
    # Load people
    with open(r"/home/ubuntu/degrees/small/people.csv", "rt", encoding="utf-8") as f2:
    ...
    # Load movies
    with open(r"/home/ubuntu/degrees/small/movies.csv", encoding="utf-8") as f:
    ...
    # Load stars
    with open(r"/home/ubuntu/degrees/small/stars.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            try:
